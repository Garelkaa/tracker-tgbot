...
# if await bot_instance.db.check_admins(uid=event.from_user.id):
#             await event.answer("<b>tracker-bot</b> - Главная страница", reply_markup=await inline.main_menu_admin())
#         else:
#             return await handler(event, data)
